...
//import naksha.demo.loadTextResource
...
//        request.add(Write().createMap(NakshaCatalog(MAP_ID)))
...
//    storage.newWriteSession().use { session ->
//        val map = session.getCatalogById(MAP_ID)
//        if (map != null) {
...
//                    var bytes = requireNotNull(tuple.toNakshaFeature())
