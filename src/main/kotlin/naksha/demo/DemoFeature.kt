...
class DemoFeature : SpFeature() {
    ...
    override fun toString()
        = "${guid?.tupleNumber?.action ?: "NEW"} $id - ${properties.name}: ${properties.age}, geo=(${geometry.asPoint().latitude}, ${geometry.asPoint().longitude}), v=${guid?.tupleNumber?.version?:"HEAD"}"
}